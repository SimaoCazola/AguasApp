...
namespace AguasApp.Migrations
{
    ...
    [Migration("20230919220054_UpdateInvoice")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AguasApp.Data.Entities.Customer", b =>
                {
                    ...
                    b.Property<int?>("InvoiceConsumptionViewModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InvoiceConsumptionViewModelId");
            ...
            modelBuilder.Entity("AguasApp.Data.Entities.MeterReading", b =>
                {
                    ...
                    b.Property<double>("RegisteredConsumption")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("AguasApp.Models.InvoiceConsumptionViewModel", b =>
                {
                    b.HasBaseType("AguasApp.Data.Entities.Invoice");

                    b.HasDiscriminator().HasValue("InvoiceConsumptionViewModel");
                });
            ...
            modelBuilder.Entity("AguasApp.Data.Entities.Customer", b =>
                {
                    b.HasOne("AguasApp.Models.InvoiceConsumptionViewModel", null)
                        .WithMany("Customers")
                        .HasForeignKey("InvoiceConsumptionViewModelId");
                });
            ...
            modelBuilder.Entity("AguasApp.Data.Entities.MeterReading", b =>
                {
                    ...
                    b.HasOne("AguasApp.Data.Entities.Customer", "Nif")
                        .WithMany()
                        .HasForeignKey("NifId");
