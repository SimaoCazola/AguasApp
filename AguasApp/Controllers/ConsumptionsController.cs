...
namespace AguasApp.Controllers
{
    public class ConsumptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Scalation,Descriptions,Price,Volume,LastReadingDate,Status")] Consumption consumption)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Scalation,Descriptions,Price,Volume,LastReadingDate,Status")] Consumption consumption)
        {
