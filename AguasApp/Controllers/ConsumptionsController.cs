...
namespace AguasApp.Controllers
{
    public class ConsumptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Volume,Price,Amount,Escalation,ConsumptionDate,Descriptions")] Consumption consumption)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Volume,Price,Amount,Escalation,ConsumptionDate,Descriptions")] Consumption consumption)
        {
