...
namespace AguasApp.Controllers
{
    public class MetersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Quantity,Description,InstallationDate")] Meter meter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Quantity,Description,InstallationDate")] Meter meter)
        {
            if (id != meter.Id)
            {
                return NotFound();
